...
def nested_loop_helper2():
    token_list_while.insert(1, '=')
    conditional_evaluation()

    if token_list_while[2] == 'True':
        token_list_while[2] = True
    else:
        token_list_while[2] = False
