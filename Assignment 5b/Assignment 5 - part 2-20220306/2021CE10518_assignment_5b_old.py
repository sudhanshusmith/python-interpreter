...
def conditional_evaluation():
    ...
    if Sudhanshu[2] == 'True':  # 1st operand value is True
        check_operand1()  # calling helper function
        if Sudhanshu[4] == 'True':  # 2nd operand value is True
            check_operand2()  # calling helper function
            Sudhanshu[2] = str(
                eval(Sudhanshu[2] + Sudhanshu[3] + Sudhanshu[4]))  # doing operations and converting into term type
            # operation()  # calling helper function
        elif Sudhanshu[4] == 'False':  # 2nd operand value is False
            check_operand2()  # calling helper function
            Sudhanshu[2] = str(
                eval(Sudhanshu[2] + Sudhanshu[3] + Sudhanshu[4]))  # doing operations and converting into term type
            # operation()  # calling helper function
    ...
    elif Sudhanshu[2] == 'False':  # 1st operand value is False
        check_operand1()  # calling helper function
        if Sudhanshu[4] == 'True':  # 2nd operand value is True
            check_operand2()  # calling helper function
            Sudhanshu[2] = str(
    ...
    elif Sudhanshu[2].isdigit():  # if 1st operand is number
        check_operand1()  # calling helper function
        if Sudhanshu[4].isdigit():  # IF 2nd operand is also number
            check_operand2()  # calling helper function
            Sudhanshu[2] = str(eval(str(Sudhanshu[2]) + Sudhanshu[3] + str(
                Sudhanshu[4])))  # doing operations and converting into term type
            # operation()  # calling helper function
        else:  # if 2nd operand is string
            if search_var(Sudhanshu[4])[0]:  # variable is defined from earlier
                Sudhanshu[4] = Data[search_var(Sudhanshu[4])[1]]  # accessing the value of variable
                Sudhanshu[2] = str(eval(str(Sudhanshu[2]) + Sudhanshu[3] + Sudhanshu[
                    4]))  # doing operations and converting into term type
                # operation()  # calling helper function
            else:  # Unexpected Input given
                raise ValueError("Variable", Sudhanshu[4], "is not defined from earlier")



    else:  # 1st operand is of variable type
        if search_var(Sudhanshu[2])[0]:  # variable is defined from earlier
            Sudhanshu[2] = Data[search_var(Sudhanshu[2])[1]]  # accessing the value of variable
            if Sudhanshu[4].isdigit():  # 2nd operand is of number type
                check_operand2()  # calling helper function
                Sudhanshu[2] = str(eval(Sudhanshu[2] + Sudhanshu[3] + str(
                    Sudhanshu[4])))  # doing operations and converting into term type
                # operation()  # calling helper function
            else:  # 2nd operand is also of variable type
                if search_var(Sudhanshu[4])[0]:  # variable is defined from earlier
                    Sudhanshu[4] = Data[search_var(Sudhanshu[4])[1]]  # accessing the value of variable
                    Sudhanshu[2] = str(eval(Sudhanshu[2] + Sudhanshu[3] + Sudhanshu[
                        4]))  # doing operations and converting into term type
                    # operation()  # calling helper function
            ...
            raise ValueError("Variable", Sudhanshu[2], "is not defined from earlier")
...
def assignment5():
    ...
    if p == 3:  # Expression is of 'Term' Type
        ...
        if Sudhanshu[2].isdigit():  # if data is of number type
            # print("Term is of Number Type")
            operation()  # calling helper function

        else:  # Expression may be of String Type
            if Sudhanshu[2] == 'True':  # Expression value is boolean
                # print("Term value is True")
                operation()  # calling helper function

            elif Sudhanshu[2] == 'False':  # Expression value is boolean
                ...
                if search_var(Sudhanshu[2])[0]:  # Variable is defined from earlier
                    ...
                    raise ValueError("Variable", Sudhanshu[2], "is not defined")
        ...
        if Sudhanshu[2] == '-':  # It's case of -2, -4 , -a  ......etc
            if Sudhanshu[3].isdigit():  # verifying that after minus there is integer or float only, not strings
                Sudhanshu[2] = str(-int(Sudhanshu[3]))  # converting in term type to apply that result
                operation()  # calling helper function

            else:  # It means after '-' there is variable in form of strings
                if search_var(Sudhanshu[3])[0]:  # Variable is defined from earlier
                    # print("Variable is defined from earlier")
                    Sudhanshu[2] = str(-int(Data[search_var(Sudhanshu[3])[1]]))  # accessing the value of variable
                    operation()  # calling helper function
                else:  # # Variable is not defined from earlier
                    raise ValueError("Variable", Sudhanshu[3], "is not defined")


        elif Sudhanshu[2] == 'not':  # If uniary operator is 'not'
            if Sudhanshu[3] == 'True':  # Its case of not True type
                Sudhanshu[2] = 'False'  # converting in term type to apply that result
                operation()  # calling helper function

            elif Sudhanshu[3] == 'False':  # It's case of not False type
                Sudhanshu[2] = 'True'  # converting in term type to apply that result
                operation()  # calling helper function
        ...
        if Sudhanshu[2] == 'True':  # 1st operand value is True
            ...
            if Sudhanshu[4] == 'True':  # 2nd operand value is True
                check_operand2()  # calling helper function
                Sudhanshu[2] = str(eval(
                    Sudhanshu[2] + Sudhanshu[3] + Sudhanshu[4]))  # doing operations and converting into term type
                operation()  # calling helper function
            elif Sudhanshu[4] == 'False':  # 2nd operand value is False
                check_operand2()  # calling helper function
                Sudhanshu[2] = str(eval(
...
def operation():  # defining the function which is a helper function of doing operation whenever required
    if search_exp(Sudhanshu[2])[0]:  # checking that given data is present inside memory or not
        # print("We checked that Data is already present")
        if search_var(Sudhanshu[0])[0]: # checking that variable is already present inside memory or not
            # print("We checked that Variable is present & already mapped to some index")
            if Data[search_var(Sudhanshu[0])[1]] == Sudhanshu[2]:  # checking that variable is mapped to right index or not?
                None # doing nothing
                ...
                y = list(Data[search_var(Sudhanshu[0])[2]])  # converting tuple to list
                y[1] = search_exp(Sudhanshu[2])[1]  # correcting the index
                Data[search_var(Sudhanshu[0])[2]] = tuple(y)  # converting list to tuple
            ...
            Data.append((Sudhanshu[0], search_exp(Sudhanshu[2])[1]))  # appending the new variable inside memory with it's mapped index
    else: # if given data is not present inside memory
        # print("We checked that data is not present, We have added data for you")
        Data.append(Sudhanshu[2]) # appending data inside the memory
        if search_var(Sudhanshu[0])[0]:  # checking that variable is already present inside memory or not
            # print("We checked that Variable is present & already mapped to some index")
            if Data[search_var(Sudhanshu[0])[1]] == Sudhanshu[2]:  # checking that variable is mapped to right index or not?
                None # doing nothing
...
def check_operand1():  # defining helper function to check wether operand1 is already present inside memory or not?
    if search_exp(Sudhanshu[2])[0]:  # If operand1 is already present inside memory
        None  # doing nothing
        ...
        Data.append(Sudhanshu[2])  # appending the operand1 inside memory


def check_operand2():  # defining helper function to check wether operand2 is already present inside memory or not?
    if search_exp(Sudhanshu[4])[0]: # If operand2 is already present inside memory
        None  # doing nothing
        ...
        Data.append(Sudhanshu[4])  # appending the operand2 inside memory
...
for i in range (0,n):
    ...
    while lines[i][tabs] == '\t':
        tabs += 1
    tabs_info.append((f'lines{i + 1}', tabs))
print(tabs_info)


loop_body_lines_number = []
while_all_loop_body_in_tuple =[]
particular_loop_body_in_tuple = []
all_loops_lines = []
i = 0
while i < n:
    if tabs_info[(i + 1)][1] == 1:
        loop_body_lines_number.append(i + 1)
        all_loops_lines.append(lines[i])
        particular_loop_body_in_tuple.append(lines[i])
        if i == n-1 and particular_loop_body_in_tuple != []:
            while_all_loop_body_in_tuple.append(particular_loop_body_in_tuple)


        i = i + 1
    else:
        i = i + 1
        if particular_loop_body_in_tuple != []:
            while_all_loop_body_in_tuple.append(particular_loop_body_in_tuple)
        particular_loop_body_in_tuple = []
...
for i in range (0,n): # each statement is on a separate line
    Sudhanshu = lines[i].split() # split a statement into a list of tokens
    p = len(Sudhanshu)  # p is length of token_list (i.e length of each line after splitting)
    print()  # breaking the output
    print("Reading Line number",(i+1),"......................................................")
    print ("Tokens:", Sudhanshu) # now process each statement
    ...
    if Sudhanshu[0] == 'while':
        ...
        if Sudhanshu[2] == 'True':
            ...
            Sudhanshu[2] = False
        # print('hiii',token_list[2])
        # print(type(token_list[2]))
        ...
        # print(token_list_while)
        while Sudhanshu[2]:
            # if token_list[1]:  # If according to the conditional we have to run the loop
            #     # write code here to run the loop
            for  j in range(0,len_of_lines_while):
                token_list_while = lines_while[j].split()

                if j == len_of_lines_while - 1:
                    Sudhanshu = token_list_while
                    assignment5()
                    Sudhanshu = lines[i].split()
                    Sudhanshu.insert(1, '=')
        ...
        # else:   # If according to the conditional we don't have to run the loop
        #     # write code here for jumping the loop
        #     None
    ...
    elif p == 3:  # Expression is of 'Term' Type
        # print("Expression is of 'Term' Type")
        ...
        if Sudhanshu[2] == 'True':  # 1st operand value is True
            ...
            if Sudhanshu[4] == 'True':  # 2nd operand value is True
                check_operand2()   # calling helper function
                Sudhanshu[2] = str(eval(Sudhanshu[2] + Sudhanshu[3] + Sudhanshu[4]))  # doing operations and converting into term type
                operation()   # calling helper function
            elif Sudhanshu[4] == 'False':   # 2nd operand value is False
                check_operand2()    # calling helper function
                Sudhanshu[2] = str(eval(Sudhanshu[2] + Sudhanshu[3] + Sudhanshu[4]))   # doing operations and converting into term type
            ...
            if Sudhanshu[4].isdigit(): # IF 2nd operand is also number
                check_operand2()   # calling helper function
                Sudhanshu[2] = str(eval(str(Sudhanshu[2]) + Sudhanshu[3] + str(Sudhanshu[4])))   # doing operations and converting into term type
                operation()    # calling helper function
            else:  # if 2nd operand is string
                if search_var(Sudhanshu[4])[0]: # variable is defined from earlier
                    Sudhanshu[4] = Data[search_var(Sudhanshu[4])[1]]   # accessing the value of variable
                    Sudhanshu[2] = str(eval(str(Sudhanshu[2]) + Sudhanshu[3] + Sudhanshu[4]))    # doing operations and converting into term type
                    operation()   # calling helper function
                else:   #Unexpected Input given
                    raise ValueError("Variable", Sudhanshu[4], "is not defined from earlier")
            ...
            if search_var(Sudhanshu[2])[0]:  # variable is defined from earlier
                ...
                if Sudhanshu[4].isdigit(): # 2nd operand is of number type
                    check_operand2()    # calling helper function
                    Sudhanshu[2] = str(eval(Sudhanshu[2] + Sudhanshu[3] + str(Sudhanshu[4])))    # doing operations and converting into term type
                    operation()    # calling helper function
                else: # 2nd operand is also of variable type
                    if search_var(Sudhanshu[4])[0]:  # variable is defined from earlier
                        Sudhanshu[4] = Data[search_var(Sudhanshu[4])[1]]   # accessing the value of variable
